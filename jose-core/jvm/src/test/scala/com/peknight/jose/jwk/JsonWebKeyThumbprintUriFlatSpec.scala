...
class JsonWebKeyThumbprintUriFlatSpec extends AsyncFlatSpec with AsyncIOSpec:
  "JsonWebKeyThumbprintUri" should "pass for RSA from RFC example 3" in {
  ...
  "JsonWebKeyThumbprintUri" should "pass for oct" in {
  ...
  "JsonWebKeyThumbprintUri" should "pass for ec 1" in {
  ...
  "JsonWebKeyThumbprintUri" should "pass for ec 2" in {
  ...
  "JsonWebKeyThumbprintUri" should "pass for ec from nimb" in {
  ...
  "JsonWebKeyThumbprintUri" should "pass for oct from nimb" in {
    val jwk = """{"kty":"oct","k":"GawgguFyGrWKav7AX4VKUg"}"""
    val expectedThumbprint = "k1JnWRfC-5zzmL72vXIuBgTLfVROXBakS4OmGcrMCoc"
    testJwkThumbprintUri(jwk, expectedThumbprint)
  }

  "JsonWebKeyThumbprintUri" should "pass for jose wg list test vector(0)" in {
  ...
  "JsonWebKeyThumbprintUri" should "pass for jose wg list test vector(1)" in {
  ...
  "JsonWebKeyThumbprintUri" should "pass for jose wg list test vector(2)" in {
  ...
  "JsonWebKeyThumbprintUri" should "pass for jose wg list test vector(3)" in {
  ...
  "JsonWebKeyThumbprintUri" should "pass for jose wg list test vector(4)" in {
