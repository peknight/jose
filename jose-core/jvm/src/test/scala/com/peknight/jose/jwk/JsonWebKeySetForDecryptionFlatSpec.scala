...
class JsonWebKeySetForDecryptionFlatSpec extends AsyncFlatSpec with AsyncIOSpec:
  "JsonWebKeySetForDecryption" should "pass for some X5 selections" in {
  ...
  "JsonWebKeySetForDecryption" should "pass for some kid selections" in {
  ...
  "JsonWebKeySetForDecryption" should "pass for some kid symmetric selections" in {
  ...
  "JsonWebKeySetForDecryption" should "pass for key ops in selector" in {
  ...
  "JsonWebKeySetForDecryption" should "pass for use in selector" in {
